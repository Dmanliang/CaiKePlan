...
public class TipView extends FrameLayout {
    ...
    /**  默认字体颜色  */
    private static final String DEFAULT_TEXT_COLOR = "#007fff";
    /**  默认字体大小  dp  */
...
//    private Drawable head_boy, head_girl;
    ...
    private TextView newTextView(){
        ...
        FrameLayout.LayoutParams lp = new FrameLayout.LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT, Gravity.CENTER_VERTICAL);
