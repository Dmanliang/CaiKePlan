...
package com.example.caikeplan.logic.wheelview;
...
import com.example.caikeplan.logic.wheelview.adapter.WheelViewAdapter;
...
public class WheelView extends View {
	...
	private void drawCenterRect(Canvas canvas) {
		...
		paint.setColor(getResources().getColor(R.color.whileDivider));
		// 设置线宽
		paint.setStrokeWidth((float) LinearLayout.LayoutParams.FILL_PARENT);
		// 绘制上边直线
