package com.example.caikeplan.logic.refresh;
...
public class SHCircleProgressBar extends ImageView {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        final TypedArray a = context.obtainStyledAttributes(
                attrs, com.scu.miomin.shswiperefresh.R.styleable.SHCircleProgressBar, defStyleAttr, 0);

        final float density = getContext().getResources().getDisplayMetrics().density;

        mBackGroundColor = a.getColor(
                com.scu.miomin.shswiperefresh.R.styleable.SHCircleProgressBar_background_color, DEFAULT_CIRCLE_BG_LIGHT);

        mProgressColor = a.getColor(
                com.scu.miomin.shswiperefresh.R.styleable.SHCircleProgressBar_progress_color, DEFAULT_CIRCLE_COLOR);
        mColors = new int[]{mProgressColor};

        mInnerRadius = a.getDimensionPixelOffset(
                com.scu.miomin.shswiperefresh.R.styleable.SHCircleProgressBar_inner_radius, -1);

        mProgressStokeWidth = a.getDimensionPixelOffset(
                com.scu.miomin.shswiperefresh.R.styleable.SHCircleProgressBar_progress_stoke_width, (int) (STROKE_WIDTH_LARGE * density));
        mArrowWidth = a.getDimensionPixelOffset(
                com.scu.miomin.shswiperefresh.R.styleable.SHCircleProgressBar_arrow_width, -1);
        mArrowHeight = a.getDimensionPixelOffset(
                com.scu.miomin.shswiperefresh.R.styleable.SHCircleProgressBar_arrow_height, -1);
        mShowArrow = a.getBoolean(com.scu.miomin.shswiperefresh.R.styleable.SHCircleProgressBar_show_arrow, true);
        mCircleBackgroundEnabled = a.getBoolean(com.scu.miomin.shswiperefresh.R.styleable.SHCircleProgressBar_enable_circle_background, true);


        mProgress = a.getInt(com.scu.miomin.shswiperefresh.R.styleable.SHCircleProgressBar_progress, 0);
        mMax = a.getInt(com.scu.miomin.shswiperefresh.R.styleable.SHCircleProgressBar_max, 100);
        a.recycle();
